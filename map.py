...
from objects.rocks.rock import Rock
import random
...
from objects.enemies.bat import Bat
from objects.enemies.spider import Spider
...
from objects.surface.lava import Lava
...
class Map:
    ...
    def __init__(self, game, width, height, destructable_obj, indestructable_obj, screen):
        ...
        self.screen = screen
        self.game = game
        self.player = player.Player(game, 50, 10)
        self.ladder = Ladder(self.game)
        ...
        self.set_position(self.ladder, field.x, field.y)
    ...
    def check_if_in_map(self, x, y, a, b):
        ...
        if 0 <= x + dx[a] < self.width and 0 <= y + dy[b] < self.height and self.check_if_taken(x + dx[a], y + dy[b]):
    ...
    def generate_surroundings(self, x, y, type):
        ...
        for i in range(num):
            ...
            while self.check_if_in_map(x, y, a, b) is None:
                a = random.randint(0, 7)
                b = random.randint(0, 7)
